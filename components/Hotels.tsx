...
const Hotels = () => {
  ...
  return (
    <div
      className=" flexCenter flex-col my-12 "
      data-aos="fade-up"
    ...
    >
      ...
      {HOTELS?.map((hotel) => (
        ...
        >
            ...
            <div className="w-6/12">
              <div className="flex flex-wrap justify-between gap-5 lg:gap-5">
                <div className="lg:flexCenter">
                  {hotel.tabs.map((tab) => (
                    <Button type="button" title={tab} variant="btn_white" />
                  ))}
                </div>
          ...
          <div
            className="hotel-list-card w-full min-h-[350px]"
            data-aos="fade-up"
            data-aos-duration="500"
          >
            <div className="bg-white flexBetween w-full h-full rounded-lg overflow-hidden">
              ...
              />
              <div
                className="flex flex-wrap justify-between gap-2 lg:gap-3 px-3"
                data-aos="fade-up"
                data-aos-duration="500"
              >
                ...
                <p className="regular-14 text-green-600">Gulmarg</p>
              </div>
            </div>
            <div className="bg-white flexBetween w-full h-full rounded-lg overflow-hidden">
              <Image
            ...
            <div className="bg-white flex w-full h-full rounded-lg overflow-hidden">
              ...
              <div className="flex flex-wrap justify-start align-start gap-2 lg:gap-1 px-3">
                <h2 className="bold-16 lg:bold-16 text-green-50">Home 2</h2>
                <p className="regular-14 text-green-600">Gulmarg</p>
              </div>
            </div>
          </div>
